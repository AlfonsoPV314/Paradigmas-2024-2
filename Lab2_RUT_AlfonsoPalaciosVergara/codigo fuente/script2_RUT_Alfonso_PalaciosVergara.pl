...
player(1, "Sofi", "red", 0, 0, 0, 7, P1),
player(2, "Martin", "yellow", 0, 0, 0, 7, P2),
...
player_play(G0, P1, 1, G01),
player_play(G01, P2, 5, G02),
player_play(G02, P1, 2, G03),
player_play(G03, P2, 5, G04),
player_play(G04, P1, 3, G05),
...
player_play(G05, P2, 0, G06),
player_play(G06, P1, 2, G07),
player_play(G07, P2, 0, G08),
player_play(G08, P1, 0, G09),
player_play(G09, P2, 4, G10),
...
player_play(G10, P1, 6, G11),
player_play(G11, P2, 3, G12),
